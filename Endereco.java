...
public class Endereco {
	...
	public String toString(){
		return this.logradouro.trim() +" - " + this.bairro.trim() + System.lineSeparator() + this.cidade.trim() + " - " +  this.estado.trim() + "/" + this.sigla.trim()+ System.lineSeparator() + this.cep.trim();  
	}
